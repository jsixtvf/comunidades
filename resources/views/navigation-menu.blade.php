<nav x-data="{ open: false }" class="bg-purple-500 border-b border-gray-100">
                    ...
                    <x-jet-dropdown align="right" width="48" contentClasses="pb-2">
                        <x-slot name="trigger">
                            ...
                            <span class="inline-flex rounded-md">
                                <button type="button" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-purple-500 hover:bg-purple-300 hover:text-gray-700 focus:outline-none transition">
                                    {{ Auth::user()->email }}
