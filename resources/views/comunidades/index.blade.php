<x-app-layout>
    ...
    @php $opciones = ['superuser','admin']; @endphp
    @php $usuario_valido = false; @endphp

        @if($activeCommunity != null)
            @if( in_array($activeCommunity->nombreRole(auth()->user()->id), $opciones) )
                @php $usuario_valido = true; @endphp
